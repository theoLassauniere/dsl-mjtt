...
class ArduinoMlAstReflection extends langium_1.AbstractAstReflection {
    getAllTypes() {
        return ['Action', 'Actuator', 'App', 'Brick', 'Condition', 'Expression', 'Operator', 'Sensor', 'Signal', 'State', 'Transition'];
    }
